...
public class FunnyCorpTest extends TestCase {
  public void testFunnyCorp() {
    ...
    SpatialPermission coffeSpatialPermission = new SpatialPermission(new EnumSpatial(genderSpace, Gender.FEMALE), new PointRelationProvider(), coffePermission);
    ...
    SpatialPermission cokeSpatialPermission = new SpatialPermission(new EnumSpatial(genderSpace, Gender.MALE), new PointRelationProvider(), cokePermission);
  ...
  public void testFunnyCorpFromStrings() {
    ...
    SpaceRelationProvider spaceRelationProviders = MapSpaceRelationProvider.Builder.newMap().add(personSpace, new PointRelationProvider()).add(genderSpace, new PointRelationProvider()).add(meritSpace, new SphereRelationProvider()).build();
  ...
  protected void check(boolean impliesExpected, SpatialPermission sp, Person person, Permission vendingMachineContentPermission) {
    Assert.assertEquals(impliesExpected, sp.implies(new SpatialPermission(person, new PointRelationProvider(), vendingMachineContentPermission)));
  }
}
