...
/**
 * Resolves {@code EnumSpatial} instances by comparing the enum constant's name against the permission string. This
...
public class EnumSpatialResiolver implements SpatialResolver {
  ...
  public Spatial resolveSpatial(Space space, String spatialString) {
    ...
    throw new InvalidPermissionStringException("no such enum", spatialString);
  }
