 ...
 * nodes must be comparable. The fact they are both contained in same space is not enough, because how we defined
 * "space" on tree (see NodeSpace class).
 * 
 * @author cstamas
 */
public class NodeRelationProvider
    extends SphereRelationProvider
{
